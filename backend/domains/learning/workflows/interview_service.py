...
from backend.domains.learning.schemas.interview import (
...
from backend.domains.learning.workflows.interview_session_manager import (
...
INTERVIEW_SYSTEM_PROMPT = load_prompt_block(
    "interview.md",
    "generation_system_prompt",
).rstrip("\n")
INTERVIEW_GENERATION_PROMPT = load_prompt_block(
    "interview.md",
    "generation_prompt",
).rstrip("\n")
ANSWER_EVALUATION_SYSTEM_PROMPT = load_prompt_block(
    "interview.md",
    "evaluation_system_prompt",
).rstrip("\n")
ANSWER_EVALUATION_PROMPT = load_prompt_block(
    "interview.md",
    "evaluation_prompt",
).rstrip("\n")
...
class InterviewService:
    ...
    def _build_generation_prompt(self, request: InterviewStartRequest) -> str:
        ...
        return INTERVIEW_GENERATION_PROMPT.format(
    ...
    def _build_evaluation_prompt(
        ...
        *,
        ...
        return ANSWER_EVALUATION_PROMPT.format(
            ...
            interview_role=session.interview_role,
