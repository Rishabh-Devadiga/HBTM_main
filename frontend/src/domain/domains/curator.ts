...
export const curatorDomain: DomainConfig = {
  ...
  dashboard: {
    ...
    quizAverage: "Growth Score",
    interviews: "Weekly Challenge",
    streak: "Habit Streak",
    startToday: "Start today",
    noCompletedInterviews: "Build momentum this week",
    interviewAnalytics: "Weekly Challenge",
    noInterviewData: "No weekly challenge yet",
    startInterview: "Open Journey",
    interviewEmptyDescription:
      "Complete one focused action, reflect on what changed, and protect the same time block tomorrow.",
