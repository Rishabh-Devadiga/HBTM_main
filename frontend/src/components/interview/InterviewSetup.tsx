        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-sm font-semibold text-blue-600">
              {activeDomain.pages.interview.setupEyebrow}
            </p>
            <h1 className="text-2xl font-bold text-slate-950 sm:text-3xl">
              {activeDomain.features.interview}
            </h1>
          </div>
        </div>
        <p className="mt-4 max-w-3xl text-sm leading-6 text-slate-600">
          {activeDomain.pages.interview.setupDescription}
        </p>
      </section>

      <section className="space-y-6 rounded-md border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
        <Field label={activeDomain.pages.interview.goalLabel}>
          <input
