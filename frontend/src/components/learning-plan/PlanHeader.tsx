  ...
  return (
    <section className="glass-panel rounded-[28px] p-5 sm:p-6">
      <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div className="flex flex-col gap-2 sm:flex-row lg:flex-col">
          ...
          <Link
            ...
            to="/progress"
          >
            {activeDomain.pages.plan.continueAction}
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <PlanMeta label={activeDomain.labels.subject} value={plan.subject} />
        <PlanMeta
          label={activeDomain.labels.skillLevel}
          value={plan.learner_level}
        />
        <PlanMeta
          label={activeDomain.labels.targetCompletion}
          value={plan.target_deadline}
        />
        <PlanMeta
          icon={<CalendarDays className="h-4 w-4" aria-hidden="true" />}
          label={activeDomain.labels.dailyCommitment}
