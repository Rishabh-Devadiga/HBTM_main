...
export function GoalStep({ error, onChange, value }: GoalStepProps) {
  ...
  return (
    <div>
      <StepHeader
        description={activeDomain.pages.onboarding.goalDescription}
        icon={Target}
        step={1}
      ...
      <div
        aria-label={activeDomain.pages.onboarding.quickGoalsLabel}
      ...
      <label className="block text-sm font-semibold text-slate-200" htmlFor="custom-goal">
        {activeDomain.pages.onboarding.customGoalLabel}
      </label>
      <input
